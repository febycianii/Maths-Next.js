 ...
 * Icons.tsx
 *
 * This file provides a set of reusable SVG icon components.
 * Using inline SVGs as React components avoids external dependencies or font files,
 * making the icons easy to style with CSS and manage.
 *
 * These icons are sourced from the 'lucide-react' library and are used
 * to enhance the user interface with visual cues.
 */
import React from 'react';

// Props type for all icon components, allowing a custom className to be passed.
type IconProps = {
    className?: string;
};
